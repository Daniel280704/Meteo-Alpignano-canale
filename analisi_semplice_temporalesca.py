...
def interpella_groq_semplice(giorno_str, fascia, tipo_pioggia, max_vento_arrotondato, trasl_kmh, trasl_dir, grandine_str):
    ...
    prompt = f"""
    Sei un meteorologo che parla al pubblico in modo diretto e chiaro. Per la giornata del {giorno_str} a Alpignano sono previsti fenomeni.
