...
def interpella_gemini(dati_testuali, oggi_str, giorni_str):
    ...
    prompt = f"""
    Sei un meteorologo professionista. Il tuo compito è scrivere un bollettino discorsivo, fluido ed elegante per Alpignano (TO) a MEDIO TERMINE, partendo dalla sintesi oraria fornita.
